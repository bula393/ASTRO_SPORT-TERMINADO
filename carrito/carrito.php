   ...
   <img id=perfil src='\imagenes\perfil.jpg'>
    ...
    <div class=centro>
                ...
                while ($fila = mysqli_fetch_assoc($resultado)) { 
                    ...
                    <div class="item-container">
                        ...
                        <div class="cantidad">
                         ...
                         <div class="nombreproc"><h1><?php echo $filas['marca']; ?> </h1> <h1> <?php echo $filas['modelo']; ?></h1></div>
                         <div class="nombreproc"><h1 >Talle:<?php echo $ftalles['nombre_talla'] ?> </h1> </div>
                         <a class="boton" href="actualizar_carrito.php?accion=borrar&idcompra=<?php echo $fila['idcompra']; ?>&producto_id=<?php echo $fila['producto_id']; ?>&tallaID=<?php echo $fila['tallaID']; ?>">
                                <h1> x </h1>
                            </a>
                    </div>
                <?php 
        ...
        <div class="item-container">
            ...
            <h1> <?php  echo $_SESSION['Ncompra'];?>   </h1>
        </div>
    </div>   
    <script>
