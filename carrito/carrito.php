  ...
  echo "<div class='all-esquina'>
   ...
   <img id=perfil src='\imagenes\perfil.jpg'>
    ...
    <script>
        ...
        // Cambia el fondo cuando el mouse entra en .borrar
        borrar.addEventListener('mouseenter', () => {
        itemContainer.style.backgroundColor = 'red'; // Cambiar el fondo a rojo
        });

        // Restaura el fondo cuando el mouse sale de .borrar
        borrar.addEventListener('mouseleave', () => {
        itemContainer.style.backgroundColor = 'orange'; // Fondo original
        });
